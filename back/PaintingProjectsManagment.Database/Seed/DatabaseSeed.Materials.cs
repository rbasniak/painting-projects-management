...
public partial class DatabaseSeed
{
    ...
    {
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialVallejoVarnish, new Quantity(200, PackageContentUnit.Mililiter), new Money(80, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialArmyPainterVarnish, new Quantity(100, PackageContentUnit.Mililiter), new Money(50, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialGswVarnish, new Quantity(60, PackageContentUnit.Mililiter), new Money(7.5, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialTamiyaTS80, new Quantity(100, PackageContentUnit.Mililiter), new Money(89, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialBiltemaMatteVarnish, new Quantity(400, PackageContentUnit.Mililiter), new Money(49, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialBiltemaGlossVarnish, new Quantity(400, PackageContentUnit.Mililiter), new Money(49, "DKK")));

        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialGswPrimer, new Quantity(60, PackageContentUnit.Mililiter), new Money(7.5, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialVallejoPrimer, new Quantity(200, PackageContentUnit.Mililiter), new Money(15, "EUR")));

        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialCitadelContrast, new Quantity(18, PackageContentUnit.Mililiter), new Money(58, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialGswAcrylic, new Quantity(17, PackageContentUnit.Mililiter), new Money(3, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialGswChrome, new Quantity(17, PackageContentUnit.Mililiter), new Money(4.6, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialTamiyaClear, new Quantity(10, PackageContentUnit.Mililiter), new Money(19, "USD")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialVallejoAcrylic, new Quantity(17, PackageContentUnit.Mililiter), new Money(19, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialAtomAcrylic, new Quantity(20, PackageContentUnit.Mililiter), new Money(3, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialAmmoAcrylic, new Quantity(17, PackageContentUnit.Mililiter), new Money(2.5, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialAmmoTransparent, new Quantity(60, PackageContentUnit.Mililiter), new Money(5, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialAmmoDrybrush, new Quantity(40, PackageContentUnit.Mililiter), new Money(4, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialAmmoCandy, new Quantity(30, PackageContentUnit.Mililiter), new Money(7.5, "EUR")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialArmyPainterAcrylic, new Quantity(17, PackageContentUnit.Mililiter), new Money(19, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialVallejoGlaze, new Quantity(60, PackageContentUnit.Mililiter), new Money(8, "EUR")));

        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialSunluWaterWashableStandardResin, new Quantity(1000, PackageContentUnit.Gram), new Money(1082 / 6, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialSunluAbsResin, new Quantity(1000, PackageContentUnit.Gram), new Money(1082 / 6, "DKK")));
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialJayoAbsResin, new Quantity(1000, PackageContentUnit.Gram), new Money(188 / 15, "USD")));
        ...
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialPaintMixingCupCorrugated, new Quantity(150, PackageContentUnit.Mililiter), new Money(3.75, "USD")));
        ...
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialDisposableBrush, new Quantity(100, PackageContentUnit.Mililiter), new Money(7, "USD")));
        ...
        context.SaveChanges();
        context.Set<Material>().Add(new Material("rodrigo.basniak", _materialVallejoLiquidMask, new Quantity(85, PackageContentUnit.Mililiter), new Money(11, "EUR")));
