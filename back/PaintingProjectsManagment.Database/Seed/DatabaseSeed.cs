...
public partial class DatabaseSeed : DatabaseSeedManager<DatabaseContext>, IDatabaseSeeder
{
    public DatabaseSeed()
    {
        ...
        AddSeed("2026-01-23 10:33: Paint catalog", new SeedInfo<DatabaseContext>(PaintCatalogSeed, EnvironmentUsage.Development | EnvironmentUsage.Production | EnvironmentUsage.Testing));
        AddSeed("2026-01-23 11:24: User paints", new SeedInfo<DatabaseContext>(UserPaintsSeed, EnvironmentUsage.Development | EnvironmentUsage.Production | EnvironmentUsage.Testing));
    }
