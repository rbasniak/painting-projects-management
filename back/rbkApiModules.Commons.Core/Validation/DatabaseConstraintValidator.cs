    ...
    where TModel : class
{
    ...
    private void ApplyForeignKeyConstraint(IForeignKey foreignKey, PropertyInfo requestProperty)
    {
    ...
    private string GetLocalizedMessage(string messageKey, string propertyName, object? parameter = null)
    {
