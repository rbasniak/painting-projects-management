...
public class Get_Project_Details_Tests
{
    ...
    public async Task Project_Details_With_Materials_Returns_Correct_Data()
    {
        ...
        using (var context = TestingServer.CreateContext())
        {
            var newMaterial1 = new Material("rodrigo.basniak", "Test Material 1", MaterialCategory.Paints, new Materials.Quantity(9, PackageContentUnit.Gram), new Materials.Money(10.5, "BRL"));
