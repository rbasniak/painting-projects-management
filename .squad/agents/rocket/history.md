...
**Infrastructure:** .NET Aspire AppHost at `src/Aspire/PaintingProjectsManagement.AppHost`. Docker required. Run with `--allow-unsecured-transport`. Always access UI via HTTPS (`https://localhost:7114`).
